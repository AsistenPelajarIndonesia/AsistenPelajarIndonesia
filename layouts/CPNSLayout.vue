<!--
  File: /components/layouts/GrammarLayout.vue
  Description: A sophisticated, reusable layout for grammar learning modules.
  This component provides a structured layout with slots for learning materials,
  practice questions, and results. It is controlled via props and emits events
  for navigation.
-->
...
<style scoped>
/* Scoped styles for the result area transition */
.fade-enter-active,
.fade-leave-active {
