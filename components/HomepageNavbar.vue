...
const components: {
  ...
  },
  {
    ...
    description: "Jadilah bintang di OSN, kesempatan emas menantimu!",
  },
  {
    title: "UKBI",
  ...
  <header class="z-10 top-0 flex h-16 px-4 justify-between md:px-6 mx-6 items-center">
                  ...
                  <NavigationMenuLink as-child>
                    ...
                    >
                      ...
                      <p class="text-sm leading-tight text-muted-foreground">
                        Bimbel GRATIS untuk semua, mari menuju Indonesia Emas
                        2045!
                      </p>
                    </a>
                  </NavigationMenuLink>
    ...
    <div class="flex items-center gap-4 md:gap-2 lg:gap-4" style="z-index: 11">
      <header>
        <SignedOut>
          <SignUpButton>
            <Button class="p-4 text-bold mr-1"> Daftar </Button>
          </SignUpButton>
          <SignInButton>
            <Button class="p-4 text-bold" variant="secondary"> Masuk </Button>
          </SignInButton>
        </SignedOut>
        <SignedIn>
