...
const airportHistory = JSON.parse(`
{
...
`);
const travelHistory = JSON.parse(`
{
  ...
  setup() {
    ...
    function initGlobe() {
      Globe = new ThreeGlobe({
        ...
        .hexPolygonColor((e) => {
          if (
            ["KGZ", "KOR", "THA", "RUS", "UZB", "KAZ", "MYS"].includes(
              e.properties.ISO_A3
            )
          ) {
            return "rgba(255,255,255, 1)";
          } else if (["IDN"].includes(e.properties.ISO_A3)) {
            return "rgba(255, 192, 18, 1)"; // Gold color for Indonesia
    ...
    onBeforeUnmount(() => {
      ...
      renderer.dispose(); // Clean up the renderer when the component is destroyed
    });
